function [log_Z, s_new_path] = cSMC_TD(X, X_tensor, s_path, dim_X, N, a, R_vec, res_per)

% [log_Z, s_path, particles] = cSMC_TD(X, X_tensor, dim_X, N, a, R_vec, res_per)
% 
% This function implements the conditional SMC algorithm for Tucker decomposition.
% 
% Inputs: X and X_tensor are the two different format of the same count data
% and dim_X has the dimensions of X_tensor.
% s_path is the trajectory of latent allocations to be conditioned on.
