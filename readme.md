...
- *Part 1* includes the experiments on model scoring with SMC and VB (Sections VI.A and VI.B). 
- *Part 2* includes the experiments on model selection with particle MCMC (Section VI.C).
